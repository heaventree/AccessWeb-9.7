...
final class TabActivation extends Tab {
	 ...
	 * @const OPTION_GROUP
	 */
	const OPTION_GROUP = 'ReadablerActivationOptionsGroup';

	/**
	 * Remote validation errors transient name
	 */
	const VALIDATION_ERRORS = 'mdp_readabler_remote_validation_errors';
    ...
    public function add_settings() {
        ...
        add_settings_section( 'mdp_readabler_settings_page_activation_section', '', null, self::OPTION_GROUP );
