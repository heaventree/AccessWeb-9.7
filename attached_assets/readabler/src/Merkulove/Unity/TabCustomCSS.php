        ...
        <div>
            <label>
                <textarea id="mdp_custom_css_fld"
                          name="mdp_readabler_<?php echo esc_attr( self::TAB_SLUG ); ?>_settings[custom_css]"
			...
			<?php if ( Plugin::get_tabs()['custom_css']['fields']['custom_css']['show_description'] ) :
				$css_description = apply_filters( 'readabler_custom_css_description', Plugin::get_tabs()['custom_css']['fields']['custom_css']['description'] );
				?>
                <p class="description"><?php echo wp_kses_post( $css_description ); ?></p>
			<?php endif; ?>
        </div>
		<?php
	}
