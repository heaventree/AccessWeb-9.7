...
final class TabAssignments extends Tab {
	...
	public function add_admin_scripts() {
		...
		wp_enqueue_script( 'mdp-readabler-assignments', Plugin::get_url() . 'src/Merkulove/Unity/assets/js/assignments' . Plugin::get_suffix() . '.js', [
			'jquery-datetimepicker-full',
			'jquery'
		], Plugin::get_version(), true );
            ...
            <div class="mdp-all-fields">
                ...
                <div class="mdp-panel mdp-panel-box mdp-date-time mdp-margin <?php $this->is_need_to_hide( 'date_time' ); ?>">
                    ...
                    <div class="mdp-period-picker-box">
                        <p class="mdp-period-picker uk-margin-top">
                            <label><input class="mdp-period-picker-start" id="mdp-period-picker-start" type="text"
                                          value=""/></label>
                            <label><input class="mdp-period-picker-end" id="mdp-period-picker-end" type="text"
                                          value=""/></label>
                        </p>
                    ...
                    <div class="languages-box">
                        ...
                        <select class="languages chosen-select" multiple="">
							...
							foreach ( $translations as $key => $language ) :
								?>
                                <option
                                value="<?php echo esc_attr( $key ); ?>"><?php echo esc_html( $language['native_name'] ); ?></option><?php
							endforeach; ?>
                        </select>
                    </div>
                        ...
                        <label>
                            <select class="user-roles chosen-select" multiple="">
								...
								foreach ( $roles as $k => $role ) {
									?>
                                    <option
                                    value="<?php echo esc_attr( $k ); ?>"><?php echo esc_attr( $role['name'] ); ?></option><?php
								} ?>
                            </select>
                        </label>
                    </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-os mdp-margin <?php $this->is_need_to_hide( 'operating_systems' ); ?>">
                    ...
                    <div class="mdp-os-box">
                        ...
                        <select class="os chosen-select" multiple="">
                            <option value=""></option>
                            <option value="Windows"><?php echo esc_attr( 'Windows (All)' ) ?></option>
                            <option value="Windows nt 10.0"><?php echo esc_attr( 'Windows 10' ) ?></option>
                            <option value="Windows nt 6.2"><?php echo esc_attr( 'Windows 8' ) ?></option>
                            <option value="Windows nt 6.1"><?php echo esc_attr( 'Windows 7' ) ?></option>
                            <option value="Windows nt 6.0"><?php echo esc_attr( 'Windows Vista' ) ?></option>
                            <option value="Windows nt 5.2"><?php echo esc_attr( 'Windows Server 2003' ) ?></option>
                            <option value="Windows nt 5.1"><?php echo esc_attr( 'Windows XP' ) ?></option>
                            <option value="Windows nt 5.01"><?php echo esc_attr( 'Windows 2000 sp1' ) ?></option>
                            <option value="Windows nt 5.0"><?php echo esc_attr( 'Windows 2000' ) ?></option>
                            <option value="Windows nt 4.0"><?php echo esc_attr( 'Windows NT 4.0' ) ?></option>
                            <option value="Win 9x 4.9"><?php echo esc_attr( 'Windows Me' ) ?></option>
                            <option value="Windows 98"><?php echo esc_attr( 'Windows 98' ) ?></option>
                            <option value="Windows 95"><?php echo esc_attr( 'Windows 95' ) ?></option>
                            <option value="Windows ce"><?php echo esc_attr( 'Windows CE' ) ?></option>
                            <option value="#(Mac OS|Mac_PowerPC|Macintosh)#"><?php echo esc_attr( 'Mac OS (All)' ) ?></option>
                            <option value="Mac OS X"><?php echo esc_attr( 'Mac OSX (All)' ) ?></option>
                            <option value="Mac OS X 10.11"><?php echo esc_attr( 'Mac OSX El Capitan' ) ?></option>
                            <option value="Mac OS X 10.10"><?php echo esc_attr( 'Mac OSX Yosemite' ) ?></option>
                            <option value="Mac OS X 10.9"><?php echo esc_attr( 'Mac OSX Mavericks' ) ?></option>
                            <option value="Mac OS X 10.8"><?php echo esc_attr( 'Mac OSX Mountain Lion' ) ?></option>
                            <option value="Mac OS X 10.7"><?php echo esc_attr( 'Mac OSX Lion' ) ?></option>
                            <option value="Mac OS X 10.6"><?php echo esc_attr( 'Mac OSX Snow Leopard' ) ?></option>
                            <option value="Mac OS X 10.5"><?php echo esc_attr( 'Mac OSX Leopard' ) ?></option>
                            <option value="Mac OS X 10.4"><?php echo esc_attr( 'Mac OSX Tiger' ) ?></option>
                            <option value="Mac OS X 10.3"><?php echo esc_attr( 'Mac OSX Panther' ) ?></option>
                            <option value="Mac OS X 10.2"><?php echo esc_attr( 'Mac OSX Jaguar' ) ?></option>
                            <option value="Mac OS X 10.1"><?php echo esc_attr( 'Mac OSX Puma' ) ?></option>
                            <option value="Mac OS X 10.0"><?php echo esc_attr( 'Mac OSX Cheetah' ) ?></option>
                            <option value="#(Mac_PowerPC|Macintosh)#"><?php echo esc_attr( 'Mac OS (classic)' ) ?></option>
                            <option value="#(Linux|X11)#"><?php echo esc_attr( 'Linux' ) ?></option>
                            <option value="OpenBSD"><?php echo esc_attr( 'Open BSD' ) ?></option>
                            <option value="SunOS"><?php echo esc_attr( 'Sun OS' ) ?></option>
                            <option value="QNX"><?php echo esc_attr( 'QNX' ) ?></option>
                            <option value="BeOS"><?php echo esc_attr( 'BeOS' ) ?></option>
                            <option value="OS/2"><?php echo esc_attr( 'OS/2' ) ?></option>
                        </select>
                    </div>
                        ...
                        <div class="mdp-widget-manager-control-box">
                            ...
                            <div>
                                ...
                                <select class="browsers chosen-select" multiple="">
                                    <option value=""></option>
                                    <option value="Chrome"><?php echo esc_attr( 'Chrome' ); ?>
                                        (<?php esc_html_e( 'All', 'readabler' ); ?>)
                                    </option>
                                    ...
                                    <option value="Firefox"><?php echo esc_attr( 'Firefox' ); ?>
                                        (<?php esc_html_e( 'All', 'readabler' ); ?>)
                                    </option>
                                    ...
                                    <option value="MSIE"><?php echo esc_attr( 'Internet Explorer' ); ?>
                                        (<?php esc_html_e( 'All', 'readabler' ); ?>)
                                    </option>
                                    ...
                                    <option value="Opera"><?php echo esc_attr( 'Opera' ); ?>
                                        (<?php esc_html_e( 'All', 'readabler' ); ?>)
                                    </option>
                                    ...
                                    <option value="Safari"><?php echo esc_attr( 'Safari' ); ?>
                                        (<?php esc_html_e( 'All', 'readabler' ); ?>)
                                    </option>
                        ...
                        <div class="mdp-widget-manager-control-box">
                            ...
                            <div>
                                ...
                                <select class="mobile-browsers chosen-select" multiple="">
                                    <option value=""></option>
                                    <option value="mobile"><?php esc_html_e( 'All', 'readabler' ); ?></option>
                ...
                <div class="mdp-panel mdp-panel-box mdp-ips mdp-margin <?php $this->is_need_to_hide( 'ip_addresses' ); ?>">
                    ...
                    <div class="mdp-ips-box">
                        ...
                        <p>
							<?php esc_html_e( 'List of IP addresses or IP ranges. Example: ', 'readabler' ); ?>
                            <br>
...
return $result;</pre>
	...
	public function display() {
		...
		/** Matching Method. */
		return $this->MatchingMethod( $assignment, [
			$wordPressContent,
			$homePage,
			$menuItems,
			$dateTime,
	...
	protected function Languages( $assignment ) {
		...
		if ( ! is_array( $assignment->languagesVal ) ) {
			return - 1;
		}
		...
		switch ( $assignment->menuItems ) {
			...
			case 1: // Include
				...
				foreach ( $menu_items_arr as $mItem ) {
					if ( isset( $mItem->url ) && $currentUrl === $mItem->url ) {
						$result = true;
	...
	protected function Browsers( $assignment ) {
		...
		/** If wrong input array - Ignore. */
		if ( ! ( is_array( $assignment->browsersVal ) || is_array( $assignment->mobileBrowsersVal ) ) ) {
			return - 1;
		}
