...
export const wcagResource15: Article = {
  "id": "wcag-resource-15",
  ...
  "publishedAt": "2023-10-10T20:56:38.957Z",
  "updatedAt": "2024-09-19T00:00:22.709Z",
  ...
  "tableOfContents": [
    ...
    {
      "id": "captions-guideline-122-level-a-for-prerecorded-124-level-aa-for-live",
      "title": "Captions (Guideline 1.2.2 - Level A for Prerecorded, 1.2.4 - Level AA for Live)",
      "level": 2
    },
    {
      "id": "what",
    ...
    {
      "id": "audio-descriptions-guideline-123-level-a-125-level-aa-for-prerecorded",
      "title": "Audio Descriptions (Guideline 1.2.3 - Level A / 1.2.5 - Level AA for Prerecorded)",
      "level": 2
    },
    {
      "id": "what",
    ...
    {
      "id": "transcripts-guideline-121-level-a-for-audio-onlyvideo-only-123-level-a-as-alternative-for-synced-media",
      "title": "Transcripts (Guideline 1.2.1 - Level A for Audio-only/Video-only, 1.2.3 - Level A as alternative for Synced Media)",
      "level": 2
    },
    {
      "id": "what",
