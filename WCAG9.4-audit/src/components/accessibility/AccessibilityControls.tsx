...
export function AccessibilityControls() {
  ...
  return (
    <>
      ...
      <button
        onClick={toggleMenu}
        className="fixed bottom-[140px] right-5 z-50 bg-cyan-500 text-white p-0 rounded-full shadow-lg focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 h-12 w-12 flex items-center justify-center"
