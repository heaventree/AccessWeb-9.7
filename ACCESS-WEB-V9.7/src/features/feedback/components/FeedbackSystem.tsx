...
const FeedbackSystem: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      if (
        widgetRef.current &&
        elementsAtPoint.some((el) => widgetRef.current?.contains(el))
      )
        return;
    ...
    const handleClick = (e: MouseEvent) => {
      ...
      document.body.querySelectorAll("*").forEach((el) => {
        ...
        const originalState = originalStates.get(htmlEl) || {
          outline: "",
          outlineOffset: "",
        };
  ...
  return (
    <div ref={widgetRef}>
      {/* Feedback Button */}
      <div className="fixed right-4 top-1/2 -translate-y-1/2 translate-y-[300px] z-50">
        {/* Category Switch */}
