...
export default function PublicAPIDocumentationPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      {/* Hero Section */}
      <div className="bg-slate-800 dark:bg-slate-900 text-white py-20 pb-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
              Integrate WCAG accessibility testing directly into your
              development workflow. Get comprehensive compliance reports
              programmatically.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Full WCAG 2.1 and 2.2 compliance testing with detailed violation
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Support for US Section 508, EU EN 301 549, and international
    ...
    "tag": "WCAG2AA"
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-600">
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">
                      Regional compliance standard: "us", "eu", or "uk"
                      (default: "us")
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">
                      WCAG level: "WCAG2A", "WCAG2AA", "WCAG2AAA", "SECTION508",
                      "EN301549" (default: "WCAG2AA")
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-yellow-800 dark:text-yellow-200 mb-4">
                  To use the AccessWeb API, you need to create an account and
                  generate an API key.
                </p>
                <Button
        ...
        <div className="mb-12">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-[#0fae96] mb-1">
                  1,000
                </div>
        ...
        <div className="text-center bg-gradient-to-r from-[#0fae96] to-[#0d9488] rounded-lg p-8 text-white">
          ...
          <p className="text-green-100 mb-6">
            Create your account today and start integrating accessibility
            testing into your workflow.
          </p>
          <Button
            onClick={handleGetStarted}
