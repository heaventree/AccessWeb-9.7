...
function FeatureCard({ icon, title, description, bulletPoints, bgColor, iconColor, index }: FeatureProps) {
  ...
  return (
    ...
    >
      <div className={`feature-icon-wrapper ${bgColor} dark:bg-opacity-20`}>
    ...
    <section id="features" className="py-24 md:py-32 bg-[#f9fdff] dark:bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground">Everything You Need for WCAG Compliance</h2>
