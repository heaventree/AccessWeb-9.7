...
export default function HeroSection({ onTrialSignup, isSubmitting }: HeroSectionProps) {
  return (
    <section className="pt-28 pb-16 md:pb-32 bg-gradient-hero">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-gradient">
              Make Your Website Accessible to <span className="text-primary-600 dark:text-[#5eead4]">Everyone</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <PlayCircle className="mr-2 h-5 w-5 text-primary-600 dark:text-[#5eead4]" />
                Watch Demo
              </button>
            </div>
          </motion.div>
